...
//$stmt_c = $db->prepare("select section.id_section, section.start from section join runner_section on section.ID_SECTION = runner_section.ID_S where runner_section.id_t=$current_team_id and runner_section.id_r is NULL order by section.ID_SECTION");
//$stmt_c->execute();
//$team_section_id = $stmt_c->fetchAll();
